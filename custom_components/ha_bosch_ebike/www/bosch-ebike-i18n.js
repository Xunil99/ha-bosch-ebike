...
export const I18N = {
  en: {
    ...
    err_leaflet_unavailable: "Leaflet loaded but is not available",
    msg_gpx_unavailable: "No GPX available for this route",
    msg_gpx_download_failed: "GPX download failed",
    msg_no_bike_selected: "No bike found. Please select a bike in the card settings.",
    ...
    editor_map_style_label: "Basemap style",
    editor_track_color_label: "Track colour",
    editor_track_opacity_label: "Track opacity (0-1)",
    editor_track_weight_label: "Track thickness (px)",
    ...
    dash_label_time_remaining_80: "Time remaining to 80%",
    dash_label_time_remaining_100: "Time remaining to 100%",
    dash_label_ready_at_80: "Estimated ready at 80%",
    dash_label_ready_at_100: "Estimated ready at 100%",
    dash_unit_min: " min",
    ...
    dash_editor_section_charge_time: "Charge-time estimate",
    dash_editor_charge_time_hint: "Based on this bike's own charging history (see the four new sensors). Hidden automatically while no estimate is available, e.g. when not charging or not enough history yet.",
    dash_editor_show_time_remaining_80: "Show time remaining to 80%",
    dash_editor_show_time_remaining_100: "Show time remaining to 100%",
    dash_editor_show_ready_at_80: "Show estimated ready time at 80%",
    dash_editor_show_ready_at_100: "Show estimated ready time at 100%",
    ...
    dash_editor_connected: "Bridge connected entity (binary)",
    dash_editor_connected_hint: "The bridge's own connection status sensor (e.g. \"eBike Connected\"). When linked and off, the live battery reading above is treated as not currently available, so the card falls back to the cloud value or the last known reading (marked with ~) instead of showing a stale live value as if it were fresh.",
    ...
    err_complete_maintenance_failed: (msg) => `Could not mark maintenance as done: ${msg}`,
    err_add_maintenance_failed: (msg) => `Could not add maintenance item: ${msg}\n\nTip: if you just updated the integration, restart Home Assistant once.`,
    err_remove_maintenance_failed: (msg) => `Could not remove maintenance item: ${msg}`,
    err_update_maintenance_failed: (msg) => `Could not update maintenance item: ${msg}\n\nTip: if you just updated the integration, restart Home Assistant once.`,
    ...
    map3d_editor_show_weather: "Show weather",
    map3d_editor_show_weather_hint: "Adds an atmospheric cloud/rain/snow/storm effect based on the ride's real historical weather. On by default.",
    ...
    // Other cards' window.customCards gallery descriptions ("Add Card" picker)
    map_card_desc: "Interactive map with GPS tracks of your Bosch eBike rides",
    heatmap_card_desc: "Overlays all rides in a selection on one map",
    calendar_card_desc: "Calendar heatmap of ride days (GitHub-contributions style)",
    dashboard_card_desc: "Bike photo, live data and optional charge control (for ESPHome bridge + smart plug)",
    map3d_card_desc: "3D ride detail view with building extrusions, time slider and sun-position lighting (MapLibre + OpenFreeMap)",
    stats_card_desc: "Bar charts for distance, elevation gain, average speed and ride count over the last 12 weeks/months",
    tricklist_card_desc: "Sortable list of all detected jumps/manuals/stoppies/wheelies with full details",
  ...
  de: {
    ...
    err_leaflet_unavailable: "Leaflet wurde geladen, ist aber nicht verfügbar",
    msg_gpx_unavailable: "Kein GPX für diese Route verfügbar",
    msg_gpx_download_failed: "GPX-Download fehlgeschlagen",
    msg_no_bike_selected: "Kein Bike gefunden. Bitte ein Bike in den Karten-Einstellungen wählen.",
    ...
    editor_account_hint: "Wenn gesetzt, wird das Konto-Dropdown ausgeblendet und die Karte zeigt nur Fahrten dieses Kontos.",
    editor_bike_label: "Bike fest auswählen (optional)",
    editor_bike_hint: "Wenn gesetzt, wird das Bike-Dropdown ausgeblendet und die Karte zeigt nur Fahrten dieses Bikes.",
    editor_map_style_label: "Kartenstil",
    editor_track_color_label: "Track-Farbe",
    editor_track_opacity_label: "Track-Deckkraft (0-1)",
    editor_track_weight_label: "Track-Stärke (px)",
    ...
    dash_label_time_remaining_80: "Restzeit bis 80%",
    dash_label_time_remaining_100: "Restzeit bis 100%",
    dash_label_ready_at_80: "Voraussichtlich fertig bei 80%",
    dash_label_ready_at_100: "Voraussichtlich fertig bei 100%",
    dash_unit_min: " min",
    dash_editor_section_modes: "Reichweite je Fahrmodus (Pillen)",
    dash_editor_show_range_pills: "Reichweite je Fahrmodus als Pillen anzeigen",
    ...
    dash_editor_section_charge_time: "Ladezeit-Schätzung",
    dash_editor_charge_time_hint: "Basiert auf der eigenen Ladehistorie dieses Bikes (siehe die vier neuen Sensoren). Wird automatisch ausgeblendet, solange keine Schätzung verfügbar ist, z. B. wenn nicht geladen wird oder noch nicht genug Historie vorliegt.",
    dash_editor_show_time_remaining_80: "Restzeit bis 80% anzeigen",
    dash_editor_show_time_remaining_100: "Restzeit bis 100% anzeigen",
    dash_editor_show_ready_at_80: "Voraussichtliche Fertigzeit bei 80% anzeigen",
    dash_editor_show_ready_at_100: "Voraussichtliche Fertigzeit bei 100% anzeigen",
    ...
    dash_editor_battery_live_hint: "Vom lokalen LDI-Bridge-ESP. Wenn gesetzt und verfügbar, wird dieser Wert in Echtzeit statt des Cloud-Akkustands angezeigt; fällt auf die Cloud-Entity zurück, wenn die Bridge offline ist.",
    dash_editor_connected: "Bridge-Verbindungsstatus-Entity (binär)",
    dash_editor_connected_hint: "Der eigene Verbindungsstatus-Sensor der Bridge (z. B. „eBike Connected“). Wenn verknüpft und aus, wird der Live-Akkustand oben als aktuell nicht verfügbar behandelt, sodass die Karte auf den Cloud-Wert oder den letzten bekannten Stand (mit ~ markiert) zurückfällt, statt einen veralteten Live-Wert wie frisch anzuzeigen.",
    ...
    err_complete_maintenance_failed: (msg) => `Wartung konnte nicht als erledigt markiert werden: ${msg}`,
    err_add_maintenance_failed: (msg) => `Wartung konnte nicht hinzugefügt werden: ${msg}\n\nTipp: Wenn du die Integration gerade aktualisiert hast, starte Home Assistant einmal neu.`,
    err_remove_maintenance_failed: (msg) => `Wartung konnte nicht entfernt werden: ${msg}`,
    err_update_maintenance_failed: (msg) => `Wartung konnte nicht aktualisiert werden: ${msg}\n\nTipp: Wenn du die Integration gerade aktualisiert hast, starte Home Assistant einmal neu.`,
    ...
    map3d_editor_preset_hint: "Wähle eine Vorlage, um sie sofort anzuwenden, oder passe die Regler unten an und speichere sie unter eigenem Namen. Vorlagen gelten kartenübergreifend, genau wie die anderen Einstellungen auf dieser Seite.",
    ...
    map3d_editor_show_weather: "Wetter anzeigen",
    map3d_editor_show_weather_hint: "Fügt einen atmosphärischen Wolken-/Regen-/Schnee-/Gewittereffekt basierend auf dem tatsächlichen historischen Wetter der Tour hinzu. Standardmäßig aktiviert.",
    ...
    map_card_desc: "Interaktive Karte mit GPS-Tracks deiner Bosch eBike-Fahrten",
    heatmap_card_desc: "Alle Touren einer Auswahl auf einer Karte überlagert",
    calendar_card_desc: "Kalender-Heatmap der Fahrtage (GitHub-Contributions-Stil)",
    dashboard_card_desc: "Bike-Bild, Live-Daten und optional Ladesteuerung (für ESPHome-Bridge + Smart-Plug)",
    map3d_card_desc: "Tour-Detailansicht in 3D mit Gebäude-Extrusionen, Zeit-Slider und Sonnenstand-Lichteffekt (MapLibre + OpenFreeMap)",
    stats_card_desc: "Balkendiagramme für Distanz, Höhenmeter, Ø-Geschwindigkeit und Touren-Anzahl über die letzten 12 Wochen/Monate",
    tricklist_card_desc: "Sortierbare Liste aller erkannten Jumps/Manuals/Stoppies/Wheelies mit allen Details",
  ...
  nl: {
    ...
    bike_reassign_hint: "Klik om deze rit aan een andere fiets toe te wijzen",
    ...
    err_leaflet_unavailable: "Leaflet is geladen, maar niet beschikbaar",
    msg_gpx_unavailable: "Geen GPX beschikbaar voor deze route",
    msg_gpx_download_failed: "GPX-download mislukt",
    msg_no_bike_selected: "Geen fiets gevonden. Kies een fiets in de kaart-editor.",
    ...
    editor_map_style_label: "Kaartstijl",
    editor_track_color_label: "Trackkleur",
    editor_track_opacity_label: "Trackdekking (0-1)",
    editor_track_weight_label: "Trackdikte (px)",
    ...
    dash_label_time_remaining_80: "Resterende tijd tot 80%",
    dash_label_time_remaining_100: "Resterende tijd tot 100%",
    dash_label_ready_at_80: "Naar verwachting klaar bij 80%",
    dash_label_ready_at_100: "Naar verwachting klaar bij 100%",
    dash_unit_min: " min",
    ...
    dash_editor_section_charge_time: "Laadtijd-schatting",
    dash_editor_charge_time_hint: "Gebaseerd op de eigen laadgeschiedenis van deze fiets (zie de vier nieuwe sensoren). Wordt automatisch verborgen zolang er geen schatting beschikbaar is, bijv. wanneer niet wordt opgeladen of er nog te weinig geschiedenis is.",
    dash_editor_show_time_remaining_80: "Resterende tijd tot 80% tonen",
    dash_editor_show_time_remaining_100: "Resterende tijd tot 100% tonen",
    dash_editor_show_ready_at_80: "Verwachte gereedtijd bij 80% tonen",
    dash_editor_show_ready_at_100: "Verwachte gereedtijd bij 100% tonen",
    ...
    dash_soc_stale_hint: (age) => `Fiets slaapt, laatst bekende waarde van ${age}`,
    ...
    dash_editor_connected: "Bridge-verbindingsstatus-entity (binair)",
    dash_editor_connected_hint: "De eigen verbindingsstatussensor van de bridge (bijv. \"eBike Connected\"). Indien gekoppeld en uit, wordt de live-accustand hierboven als momenteel niet beschikbaar behandeld, waardoor de kaart terugvalt op de cloudwaarde of de laatst bekende stand (gemarkeerd met ~) in plaats van een verouderde live-waarde als vers te tonen.",
    ...
    dash_editor_bike_id: "Fiets",
    dash_editor_maint_pick_bike: "Kies hierboven een fiets om het onderhoud ervan te beheren.",
    dash_editor_maint_none_yet: 'Nog geen onderhoudsitems. Klik op „Onderhoud toevoegen” om er een aan te maken.',
    err_complete_maintenance_failed: (msg) => `Onderhoud kon niet als gedaan worden gemarkeerd: ${msg}`,
    err_add_maintenance_failed: (msg) => `Onderhoudsitem kon niet worden toegevoegd: ${msg}\n\nTip: als je de integratie net hebt bijgewerkt, herstart dan Home Assistant eenmaal.`,
    err_remove_maintenance_failed: (msg) => `Onderhoudsitem kon niet worden verwijderd: ${msg}`,
    err_update_maintenance_failed: (msg) => `Onderhoudsitem kon niet worden bijgewerkt: ${msg}\n\nTip: als je de integratie net hebt bijgewerkt, herstart dan Home Assistant eenmaal.`,
    ...
    map3d_editor_bike: "Fiets vastzetten (optioneel)",
    ...
    map3d_editor_fpv_lookahead_hint: "Hoe ver voor de fiets de FPV-camera mikt, in meters. Alleen actief in FPV-modus.",
    ...
    map3d_editor_smooth_window_hint: "Hoger = soepelere camera, trager. 15 is een goede default; 5 is schokkerig, 40 neemt bochten in een brede boog.",
    ...
    map3d_editor_show_weather: "Weer tonen",
    map3d_editor_show_weather_hint: "Voegt een atmosferisch wolken-/regen-/sneeuw-/onweereffect toe op basis van het werkelijke historische weer tijdens de rit. Standaard aan.",
    ...
    map_card_desc: "Interactieve kaart met GPS-tracks van je Bosch eBike-ritten",
    heatmap_card_desc: "Legt alle ritten van een selectie over elkaar op één kaart",
    calendar_card_desc: "Kalender-heatmap van ritdagen (GitHub-contributions-stijl)",
    dashboard_card_desc: "Fietsafbeelding, live data en optioneel laadbediening (voor ESPHome-bridge + smart-plug)",
    map3d_card_desc: "Tourdetailweergave in 3D met gebouw-extrusies, tijd-slider en zonnestand-lichteffect (MapLibre + OpenFreeMap)",
    stats_card_desc: "Staafdiagrammen voor afstand, hoogtemeters, gemiddelde snelheid en aantal ritten over de laatste 12 weken/maanden",
    tricklist_card_desc: "Sorteerbare lijst van alle gedetecteerde Jumps/Manuals/Stoppies/Wheelies met alle details",
  ...
  fr: {
    ...
    editor_chase_section: "Lecture chase-cam (partagée)",
    ...
    err_leaflet_unavailable: "Leaflet a été chargé, mais n'est pas disponible",
    msg_gpx_unavailable: "Aucun GPX disponible pour cet itinéraire",
    msg_gpx_download_failed: "Échec du téléchargement GPX",
    msg_no_bike_selected: "Aucun vélo trouvé. Sélectionne un vélo dans l'éditeur de carte.",
    ...
    editor_map_style_label: "Style de fond de carte",
    editor_track_color_label: "Couleur du tracé",
    editor_track_opacity_label: "Opacité du tracé (0-1)",
    editor_track_weight_label: "Épaisseur du tracé (px)",
    ...
    dash_label_time_remaining_80: "Temps restant jusqu'à 80%",
    dash_label_time_remaining_100: "Temps restant jusqu'à 100%",
    dash_label_ready_at_80: "Prêt à 80%",
    dash_label_ready_at_100: "Prêt à 100%",
    dash_unit_min: " min",
    ...
    dash_editor_mode_colors_hint: "Attribue une couleur à chaque mode (comme dans l'app Bosch Flow). « Auto » utilise la couleur Bosch par défaut.",
    ...
    dash_editor_section_charge_time: "Estimation du temps de charge",
    dash_editor_charge_time_hint: "Basé sur l'historique de charge propre à ce vélo (voir les quatre nouveaux capteurs). Masqué automatiquement tant qu'aucune estimation n'est disponible, par ex. en dehors d'une charge ou faute d'historique suffisant.",
    dash_editor_show_time_remaining_80: "Afficher le temps restant jusqu'à 80%",
    dash_editor_show_time_remaining_100: "Afficher le temps restant jusqu'à 100%",
    dash_editor_show_ready_at_80: "Afficher l'heure de fin de charge estimée à 80%",
    dash_editor_show_ready_at_100: "Afficher l'heure de fin de charge estimée à 100%",
    ...
    dash_editor_connected: "Entité statut de connexion du pont (binaire)",
    dash_editor_connected_hint: "Le propre capteur de statut de connexion du pont (par ex. « eBike Connected »). Si liée et à l'état éteint, la valeur de batterie en direct ci-dessus est considérée comme actuellement indisponible, donc la carte revient à la valeur cloud ou à la dernière valeur connue (marquée d'un ~) au lieu d'afficher une valeur en direct obsolète comme si elle était fraîche.",
    ...
    err_complete_maintenance_failed: (msg) => `Impossible de marquer la maintenance comme fait : ${msg}`,
    err_add_maintenance_failed: (msg) => `Impossible d'ajouter la maintenance : ${msg}\n\nAstuce : si tu viens de mettre à jour l'intégration, redémarre Home Assistant une fois.`,
    err_remove_maintenance_failed: (msg) => `Impossible de supprimer la maintenance : ${msg}`,
    err_update_maintenance_failed: (msg) => `Impossible de modifier la maintenance : ${msg}\n\nAstuce : si tu viens de mettre à jour l'intégration, redémarre Home Assistant une fois.`,
    ...
    dash_editor_energy_entities_hint: "Choisis les capteurs \"Énergie chargée (7/30/365 jours)\" de ce vélo, créés automatiquement par l'intégration.",
    ...
    map3d_editor_show_weather: "Afficher la météo",
    map3d_editor_show_weather_hint: "Ajoute un effet atmosphérique de nuages/pluie/neige/orage basé sur la météo historique réelle de la sortie. Activé par défaut.",
    ...
    map_card_desc: "Carte interactive avec les tracés GPS de tes sorties Bosch eBike",
    heatmap_card_desc: "Superpose toutes les sorties d'une sélection sur une seule carte",
    calendar_card_desc: "Heatmap calendrier des jours de sortie (style contributions GitHub)",
    dashboard_card_desc: "Photo du vélo, données en direct et pilotage de charge optionnel (pont ESPHome + prise connectée)",
    map3d_card_desc: "Vue détaillée 3D d'une sortie avec extrusions de bâtiments, curseur temporel et éclairage selon la position du soleil (MapLibre + OpenFreeMap)",
    stats_card_desc: "Graphiques en barres pour la distance, le dénivelé, la vitesse moyenne et le nombre de sorties sur les 12 dernières semaines/mois",
    tricklist_card_desc: "Liste triable de tous les jumps/manuals/stoppies/wheelies détectés, avec tous les détails",
    rp_default_title: "Planificateur d'itinéraires",
    rp_hint_click: "Clique sur la carte pour définir le départ et l'arrivée — des clics supplémentaires ajoutent des points intermédiaires. Glisser un marqueur = déplacer, cliquer sur un marqueur = supprimer.",
    rp_profile_label: "Profil",
    rp_profile_trekking: "Trekking",
    ...
    rp_estimate_note: "Estimation basée sur ta consommation moyenne — l'autonomie réelle dépend du mode d'assistance, du relief, du vent et de la température.",
  ...
  it: {
    ...
    err_leaflet_unavailable: "Leaflet è stato caricato ma non è disponibile",
    msg_gpx_unavailable: "Nessun GPX disponibile per questo percorso",
    msg_gpx_download_failed: "Download GPX fallito",
    msg_no_bike_selected: "Nessuna bici trovata. Seleziona una bici nell'editor della scheda.",
    ...
    editor_map_style_label: "Stile mappa",
    editor_track_color_label: "Colore del tracciato",
    editor_track_opacity_label: "Opacità del tracciato (0-1)",
    editor_track_weight_label: "Spessore del tracciato (px)",
    ...
    stats_bike_unassigned: "Non assegnata",
    ...
    dash_label_time_remaining_80: "Tempo rimanente all'80%",
    dash_label_time_remaining_100: "Tempo rimanente al 100%",
    dash_label_ready_at_80: "Pronta all'80%",
    dash_label_ready_at_100: "Pronta al 100%",
    dash_unit_min: " min",
    ...
    dash_editor_section_charge_time: "Stima tempo di ricarica",
    dash_editor_charge_time_hint: "Basata sullo storico di ricarica di questa bici (vedi i quattro nuovi sensori). Viene nascosta automaticamente finché non è disponibile una stima, ad es. quando non è in carica o non c'è ancora abbastanza storico.",
    dash_editor_show_time_remaining_80: "Mostra tempo rimanente all'80%",
    dash_editor_show_time_remaining_100: "Mostra tempo rimanente al 100%",
    dash_editor_show_ready_at_80: "Mostra ora prevista di fine ricarica all'80%",
    dash_editor_show_ready_at_100: "Mostra ora prevista di fine ricarica al 100%",
    ...
    dash_editor_connected: "Entità stato connessione del bridge (binaria)",
    dash_editor_connected_hint: "Il sensore di stato connessione proprio del bridge (ad es. \"eBike Connected\"). Se collegata e spenta, il valore live della batteria sopra viene considerato non disponibile al momento, quindi la card ricade sul valore cloud o sull'ultimo valore noto (contrassegnato con ~) invece di mostrare un valore live obsoleto come se fosse fresco.",
    ...
    map_editor_visibility_hint: "Nascondi intestazione, navigatore date o menu di ordinamento per liberare spazio per la mappa. Tutti e tre sono visibili per impostazione predefinita. Nascondere il navigatore date rimuove l'unico modo per cambiare uscita: la scheda mostrerà sempre l'uscita che risulta prima nell'ordinamento attuale (la più recente, per impostazione predefinita).",
    ...
    err_complete_maintenance_failed: (msg) => `Impossibile segnare la manutenzione come fatta: ${msg}`,
    err_add_maintenance_failed: (msg) => `Impossibile aggiungere la voce di manutenzione: ${msg}\n\nSuggerimento: se hai appena aggiornato l'integrazione, riavvia Home Assistant una volta.`,
    err_remove_maintenance_failed: (msg) => `Impossibile rimuovere la voce di manutenzione: ${msg}`,
    err_update_maintenance_failed: (msg) => `Impossibile aggiornare la voce di manutenzione: ${msg}\n\nSuggerimento: se hai appena aggiornato l'integrazione, riavvia Home Assistant una volta.`,
    ...
    map3d_editor_show_weather: "Mostra meteo",
    map3d_editor_show_weather_hint: "Aggiunge un effetto atmosferico di nuvole/pioggia/neve/temporale basato sul meteo storico reale dell'uscita. Attivo per impostazione predefinita.",
    ...
    map_card_desc: "Mappa interattiva con le tracce GPS delle tue uscite Bosch eBike",
    heatmap_card_desc: "Sovrappone tutte le uscite di una selezione su un'unica mappa",
    calendar_card_desc: "Heatmap calendario dei giorni con uscite (stile contributi GitHub)",
    dashboard_card_desc: "Foto della bici, dati live e controllo di ricarica opzionale (per bridge ESPHome + presa intelligente)",
    map3d_card_desc: "Vista dettagliata in 3D dell'uscita con estrusioni degli edifici, slider temporale ed effetto luce basato sulla posizione del sole (MapLibre + OpenFreeMap)",
    stats_card_desc: "Grafici a barre per distanza, dislivello, velocità media e numero di uscite sulle ultime 12 settimane/mesi",
    tricklist_card_desc: "Elenco ordinabile di tutti i Jump/Manual/Stoppie/Wheelie rilevati con tutti i dettagli",
  ...
  es: {
    ...
    err_leaflet_unavailable: "Leaflet se ha cargado, pero no está disponible",
    msg_gpx_unavailable: "No hay GPX disponible para esta ruta",
    msg_gpx_download_failed: "Error al descargar el GPX",
    msg_no_bike_selected: "No se ha encontrado ninguna bici. Selecciona una bici en el editor de la tarjeta.",
    ...
    profile_avg_max_rpm: (avg, max) => `Ø ${avg} rpm · Máx ${max} rpm`,
    profile_avg_max_w: (avg, max) => `Ø ${avg} W · Máx ${max} W`,
    // Wikipedia popup
    ...
    editor_map_style_label: "Estilo del mapa",
    editor_track_color_label: "Color del trazado",
    editor_track_opacity_label: "Opacidad del trazado (0-1)",
    editor_track_weight_label: "Grosor del trazado (px)",
    ...
    dash_label_time_remaining_80: "Tiempo restante hasta el 80%",
    dash_label_time_remaining_100: "Tiempo restante hasta el 100%",
    dash_label_ready_at_80: "Lista al 80%",
    dash_label_ready_at_100: "Lista al 100%",
    dash_unit_min: " min",
    ...
    dash_editor_section_charge_time: "Estimación del tiempo de carga",
    dash_editor_charge_time_hint: "Basada en el propio historial de carga de esta bici (ver los cuatro sensores nuevos). Se oculta automáticamente mientras no haya una estimación disponible, p. ej. cuando no se está cargando o aún no hay suficiente historial.",
    dash_editor_show_time_remaining_80: "Mostrar tiempo restante hasta el 80%",
    dash_editor_show_time_remaining_100: "Mostrar tiempo restante hasta el 100%",
    dash_editor_show_ready_at_80: "Mostrar hora estimada de fin de carga al 80%",
    dash_editor_show_ready_at_100: "Mostrar hora estimada de fin de carga al 100%",
    ...
    dash_editor_connected: "Entidad de estado de conexión del puente (binaria)",
    dash_editor_connected_hint: "El propio sensor de estado de conexión del puente (p. ej. \"eBike Connected\"). Si está vinculada y desactivada, el valor de batería en vivo de arriba se trata como no disponible actualmente, por lo que la tarjeta recurre al valor de la nube o al último valor conocido (marcado con ~) en lugar de mostrar un valor en vivo obsoleto como si fuera reciente.",
    ...
    err_complete_maintenance_failed: (msg) => `No se pudo marcar el mantenimiento como hecho: ${msg}`,
    err_add_maintenance_failed: (msg) => `No se pudo añadir el elemento de mantenimiento: ${msg}\n\nConsejo: si acabas de actualizar la integración, reinicia Home Assistant una vez.`,
    err_remove_maintenance_failed: (msg) => `No se pudo eliminar el elemento de mantenimiento: ${msg}`,
    err_update_maintenance_failed: (msg) => `No se pudo actualizar el elemento de mantenimiento: ${msg}\n\nConsejo: si acabas de actualizar la integración, reinicia Home Assistant una vez.`,
    ...
    map3d_editor_show_weather: "Mostrar el tiempo",
    map3d_editor_show_weather_hint: "Añade un efecto atmosférico de nubes/lluvia/nieve/tormenta basado en el tiempo histórico real de la ruta. Activado por defecto.",
    ...
    map_card_desc: "Mapa interactivo con las trazas GPS de tus rutas Bosch eBike",
    heatmap_card_desc: "Superpone todas las rutas de una selección en un mismo mapa",
    calendar_card_desc: "Heatmap de calendario de los días activos (estilo contribuciones de GitHub)",
    dashboard_card_desc: "Imagen de la bici, datos en vivo y control de carga opcional (para puente ESPHome + enchufe inteligente)",
    map3d_card_desc: "Vista de detalle de ruta en 3D con extrusiones de edificios, slider de tiempo e iluminación según la posición del sol (MapLibre + OpenFreeMap)",
    stats_card_desc: "Gráficos de barras de distancia, desnivel positivo, velocidad media y número de rutas de las últimas 12 semanas/meses",
    tricklist_card_desc: "Lista ordenable de todos los Jumps/Manuals/Stoppies/Wheelies detectados, con todos los detalles",
    ...
    rp_stat_ascent: "Ascenso",
    rp_stat_descent: "Descenso",
  ...
  cs: {
    ...
    bike_reassign_hint: "Kliknutím přiřadíš jízdu jinému kolu",
    ...
    err_leaflet_unavailable: "Leaflet se načetl, ale není dostupný.",
    msg_gpx_unavailable: "Pro tuto trasu není k dispozici žádné GPX.",
    msg_gpx_download_failed: "Stažení GPX selhalo.",
    msg_no_bike_selected: "Nebylo nalezeno žádné kolo. Vyber kolo v nastavení karty.",
    ...
    editor_map_style_label: "Styl mapy",
    editor_track_color_label: "Barva trasy",
    editor_track_opacity_label: "Krytí trasy (0-1)",
    editor_track_weight_label: "Tloušťka trasy (px)",
    ...
    tricklist_summary_count: (n) => `celkem ${n} ${n === 1 ? "trik" : (n >= 2 && n <= 4) ? "triky" : "triků"}`,
    ...
    dash_label_time_remaining_80: "Zbývající čas do 80 %",
    dash_label_time_remaining_100: "Zbývající čas do 100 %",
    dash_label_ready_at_80: "Odhadovaná připravenost při 80 %",
    dash_label_ready_at_100: "Odhadovaná připravenost při 100 %",
    dash_unit_min: " min",
    ...
    dash_editor_section_charge_time: "Odhad doby nabíjení",
    dash_editor_charge_time_hint: "Založeno na vlastní historii nabíjení tohoto kola (viz čtyři nové senzory). Automaticky skryto, dokud není k dispozici žádný odhad, např. mimo nabíjení nebo při nedostatku historie.",
    dash_editor_show_time_remaining_80: "Zobrazit zbývající čas do 80 %",
    dash_editor_show_time_remaining_100: "Zobrazit zbývající čas do 100 %",
    dash_editor_show_ready_at_80: "Zobrazit odhadovaný čas dokončení při 80 %",
    dash_editor_show_ready_at_100: "Zobrazit odhadovaný čas dokončení při 100 %",
    ...
    dash_editor_connected: "Entita stavu připojení mostu (binární)",
    dash_editor_connected_hint: "Vlastní senzor stavu připojení mostu (např. „eBike Connected“). Když je propojená a vypnutá, živá hodnota baterie výše se považuje za aktuálně nedostupnou, takže karta se vrátí na cloudovou hodnotu nebo poslední známý stav (označený ~) místo zobrazení zastaralé živé hodnoty, jako by byla čerstvá.",
    ...
    dash_editor_maint_pick_bike: "Vyber kolo výše a spravuj jeho položky údržby.",
    dash_editor_maint_none_yet: "Zatím žádné položky údržby. Klikni na „Přidat údržbu“ a vytvoř první.",
    err_complete_maintenance_failed: (msg) => `Údržbu se nepodařilo označit jako hotovou: ${msg}`,
    err_add_maintenance_failed: (msg) => `Položku údržby se nepodařilo přidat: ${msg}\n\nTip: Po aktualizaci integrace restartuj jednou Home Assistant.`,
    err_remove_maintenance_failed: (msg) => `Položku údržby se nepodařilo odebrat: ${msg}`,
    err_update_maintenance_failed: (msg) => `Položku údržby se nepodařilo aktualizovat: ${msg}\n\nTip: Po aktualizaci integrace restartuj jednou Home Assistant.`,
    ...
    map3d_editor_terrain_exag: "Zveličení terénu (1.0-3.0)",
    ...
    map3d_sun_morning: "Denní světlo",
    ...
    map3d_editor_show_weather: "Zobrazit počasí",
    map3d_editor_show_weather_hint: "Přidá atmosférický efekt mraků/deště/sněhu/bouřky podle skutečného historického počasí při jízdě. Ve výchozím stavu zapnuto.",
    ...
    map_card_desc: "Interaktivní mapa s GPS trasami tvých jízd na Bosch eBike",
    heatmap_card_desc: "Všechny jízdy z výběru překryté na jedné mapě",
    calendar_card_desc: "Kalendářová mapa aktivity dnů s jízdou (jako graf commitů na GitHubu)",
    dashboard_card_desc: "Obrázek kola, živá data a volitelné ovládání nabíjení (pro ESPHome most + chytrou zásuvku)",
    map3d_card_desc: "Detailní 3D zobrazení jízdy s extruzí budov, časovým posuvníkem a osvětlením podle polohy slunce (MapLibre + OpenFreeMap)",
    stats_card_desc: "Sloupcové grafy vzdálenosti, převýšení, průměrné rychlosti a počtu jízd za posledních 12 týdnů/měsíců",
    tricklist_card_desc: "Řaditelný seznam všech rozpoznaných triků Jump/Manual/Stoppie/Wheelie se všemi podrobnostmi",
